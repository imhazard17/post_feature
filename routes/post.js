...
// POST /post/create
router.post('/create', [postInputValidation, authentication, upload.array("file", 7)], errForward(
    async (req, res) => {
...
// PUT /post/update/:id
router.put('/update/:id', [postInputValidation, authentication, upload.array('file', 7)], errForward(
    async (req, res) => {
